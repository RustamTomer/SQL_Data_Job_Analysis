...
🔍 SQL Queries? Cheeck them out here: [project_sql folder](/project_sql/)

# Background
Driven by a quest to navigate the data analyst job market effieciently, this project was bon from a desire to pinpoint top-paid and in-demand skills, streamlining others work to find optimal jobs.
...
# The Analysis
Each query for this project aimed at investigating specific aespects of the data analyst job market. Here's how I approached each question:
...
- **Diverse Employers:** Companies like SmartAssetm, Meta and AT&T are among those offering high salaries, showing a broad interest across different industries.
...
![SKills associatd with Top Paying Jobs](/assests/2_top_paying_roles_skills.png)
